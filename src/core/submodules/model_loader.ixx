...
// export class ModelLoader final
//{
// public:
...
// module :private;
//
// bool ModelLoader::load(fs::path filename)
//{
...
//
//     hr = CreateWICTextureFromMemory(dev_, devcon_, reinterpret_cast<const unsigned char*>(embeddedTexture->pcData),
